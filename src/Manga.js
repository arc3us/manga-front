  ...
  return (
    <div className="mt-4 ml-4 table table-fixed">
      <tr className="">
        ...
        <td className="font-bold text-3xl text-left text-top h-1/4" rowSpan="1">
          Name of Manga
        </td>
      </tr>
      <tr className="">
        ...
        >
          ...
          >
            ...
            ligula. Praesent viverra hendrerit lacinia. Nulla ac nisi vulputate,
            feugiat metus nec, dignissim quam. Mauris vitae euismod augue.
            Mauris vehicula ut nunc in viverra. Sed tempor.
          </p>
        </td>
      </tr>
      ...
      <tr className="table-row border">
        <td className="text-2xl flex-inline">
          ...
          <div className="tooltip tooltip-bottom" data-tip="70% users liked this">
          <progress
